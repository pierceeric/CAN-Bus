...
void loop() 
{
  ...
  canMsg.data[0] = myCount;             //Update value in Data Byte[0] //Why is this not incrementing over CAN ???
  canMsg.data[1] = 0x01;            //Update value in Data Byte[1]
  canMsg.data[2] = 0x01;             //Update value in Data Byte[2]
  canMsg.data[3] = 0x01;            //Update value in Data Byte[3]
  canMsg.data[4] = 0x01;             //Update value in Data Byte[4]
  canMsg.data[5] = 0x01;            //Update value in Data Byte[5]
  canMsg.data[6] = 0x01;             //Update value in Data Byte[6]
  canMsg.data[7] = 0x01;            //Update value in Data Byte[7]

  mcp2515.sendMessage(&canMsg);     //Send the CAN message

  SERIAL_PORT_MONITOR.println("Evil CAN message sent!");
